...
pluralCaseList.push( {plural: "runnings/runnings", pascal: "RunningRunning"} )

pluralCaseList.push( {plural: "ranks/rankings", pascal: "RankRanking"} )

pluralCaseList.push( {plural: "friendRelations/friends", pascal: "FriendRelationFriends"} )
pluralCaseList.push( {plural: "friendRelations/likes", pascal: "FriendRelationLikes"} )

pluralCaseList.push( {plural: "loggings/logs", pascal: "LoggingLog"} )
